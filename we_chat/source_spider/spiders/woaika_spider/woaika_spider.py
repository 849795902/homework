...
class AppSpider(scrapy.Spider):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.keyword = kwargs.get("keyword", '上车')
        self.page = kwargs.get("page", 1)
        self.start_url = "https://bbs.51credit.com/search.html?q={}&source=pc_bbs".format(self.keyword)

    def start_requests(self):
        yield scrapy.Request(
            url=self.start_url, callback=self.parse_index,
            dont_filter=True
        )
